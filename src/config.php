...
define('SEMANTICO_PATH', BASE_PATH . DIRECTORY_SEPARATOR . 'analise' . DIRECTORY_SEPARATOR . 'semantico');
...
define('GRAMATICA_PATH', TABELA_SINTATICA_PATH . DIRECTORY_SEPARATOR . 'gramaticaLivreDeContexto.txt');
